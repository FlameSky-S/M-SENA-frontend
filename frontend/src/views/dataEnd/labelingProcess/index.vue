    ...
    <div class="top-row">
      <el-row :gutter="30">
        ...
        <el-col :xs="24" :sm="8" :md="8" :lg="4" :xl="4">
          ...
          <el-form>
            <el-form-item>
              <el-button style="width: 150px" type="green" @click="labelAudio">
                Audio Label
              </el-button>
            </el-form-item>
            <el-form-item>
              <el-button style="width: 150px" type="blue" @click="labelText">
                Text Label
              </el-button>
            </el-form-item>
            <el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      async fetchAllProgress() {
        ...
        this.chart_1_height = data.users.length * 40 + 50
        this.chart_1_height = this.chart_1_height + 'px'
        chart_dv_1.style.height = this.chart_1_height
        this.myChart_1 = echarts.init(chart_dv_1)
      ...
      async fetchDetails() {
        ...
        const { data, totalCount } = await getLabelingDetails({
          ...
          status_filter: this.queryForm.status,
          datasetName: this.queryForm.datasetName,
        })
